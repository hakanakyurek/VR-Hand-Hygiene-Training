...
namespace Assets.ManusVR.Scripts.PhysicalInteraction
{
    public class PhysicsThumb : Finger
    {
        ...
        {
            base.Start();
            //_thumbRigidbody = PhalangesGameObjects[1].GetComponent<Rigidbody>();
            ...
            ConfigureThumb(PhalangesGameObjects[1]);

            AddHingeJoint(PhalangesGameObjects[2], -Hand.WristTransform.right, _thumbRigidbody);
            _phalange = HandFactory.GetPhalange(PhalangesGameObjects[2], Index, 2, DeviceType);
        }
